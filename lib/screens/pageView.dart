  ...
  void startTimer() {
    timer = Timer.periodic(Duration(seconds: 2), (Timer timer) {
      ...
      if (controller.hasClients) {
        final int nextPage = (controller.page!.round() + 1) % 3;
        ...
        Expanded(
          child: PageView(
            ...
            children: [
              ...
              phase4(
                  'assets/images/shekharA.jpeg',
                  "Shri Shekhar Anand, I.A.S. Secretary, Home Department, Bihar",
                  "I would like to appreciate Nishant Shekhar, managing partner of NS Apps Innovations, for putting his best efforts into the development and implementation of ASPIRE App in our district. We have been using ASPIRE app for a while and have evaluated positive results. I could gladly say that it has proven to be an effective and efficient way of registering attendance, especially in the case of field employees"),
              phase4(
                  'assets/images/pranav.jpeg',
                  "Shri Aman Kumar, I.A.S. Secretary, Home Department, Bihar",
                  "Good Veryu Good"),
